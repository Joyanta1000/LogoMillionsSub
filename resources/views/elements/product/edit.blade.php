                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="sm:flex sm:space-x-3 space-y-5 sm:space-y-0">
                        <div class="flex justify-center items-center sm:block sm:justify-start sm:items-start ">
                            <img src="{{$obj->getFirstMediaUrl('images', 'thumb')}}" class="sm:w-[15rem] w-[17rem] border-gray-200 rounded">
                        </div>
                        <input name="url"
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <textarea name="description"
                        ...
                        id="editor" type="text" placeholder="">{{ $obj->description }}
                </textarea>
            ...
            <div class="flex flex-wrap -mx-3 mb-2 mt-2">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    @if (empty($obj->deleted_at))
                        <form action="{{ route('product.destroy', $obj->id) }}" method="post">
                            @method('DELETE')
                            @csrf
                    ...
                    @else
                        <form action="{{ route('product.restore', $obj->id) }}" method="post">
                            @method('PUT')
                            @csrf
                            <button
