        ...
        <div class="flex flex-col">
            <div class="w-full">
                <div class="p-8 border-b border-gray-200 shadow grid grid-cols-1 gap-5">
                    <a class=" h-8 w-[11rem] text-center " href="{{ route('slider_heading.create') }}">
                        <div
                            ...
                            <tbody class="bg-white divide-y divide-gray-300 ">
                                @foreach ($data as $q)
                                    <tr class="text-center whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500">
                                            @if (!$q->deleted_at)
                                                <form action="{{ route('slider_heading.destroy', $q->id) }}" method="post">
                                                    @method('DELETE')
                                                    @csrf
                                            ...
                                            @else
                                                <form action="{{ route('slider_heading.restore', $q->id) }}" method="post">
                                                    @method('PUT')
                                                    @csrf
                                                    <button type="submit" class="inline-block text-center">
                                                        <svg class="w-6 h-6" version="1.1" id="Capa_1"
                                        ...
                                        <td class="px-6 py-4">
                                            <a href="{{ route('slider_heading.edit', $q->id) }}" class="inline-block text-center">
