<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Create New Order Category Amenities') }}
        </h2>
    </x-slot>

    <div class="container py-6 flex justify-center items-center">
        <form class="w-full sm:w-[50rem] mx-5 sm:mx-0" action="{{ route('order_category_amenities.store') }}" method="post"
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <option value="{{$q->id}}" {{old('order_category_id') == $q->id ? "selected" : ""}}>{{$q->name}}</option>
                    @endforeach
                    </select>
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input name="name"
                        ...
                        id="grid-name" type="text" placeholder="Logo Ex..." value="{{ old('name') }}">
                    @error('name')
                        <div class="text-sm text-red-600">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full px-3">
                    ...
                    <textarea name="info"
                        ...
                        id="editor" type="text" placeholder="">{{ old('info') }}
                </textarea>
